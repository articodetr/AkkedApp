...
export default function BackupScreen() {
  ...
  const handleImportData = () => {
    Alert.alert('غير متاح حاليًا', 'استيراد البيانات لا يعمل الآن');
  };
      ...
      <ScrollView style={styles.content}>
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            يمكنك الآن تصدير نسخة JSON فعلية من بياناتك. استيراد نسخة محفوظة سابقًا غير متاح حاليًا.
