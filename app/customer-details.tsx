    ...
    try {
      ...
      if (formatType === 'excel') {
        ...
        const excelBase64 = await generateAccountStatementXlsxBase64({
          ...
          logoDataUrl,
          companyHeader: {
            nameAr: settings?.shop_name,
            nameEn: settings?.shop_name_en || settings?.shop_name,
            phoneAr: settings?.shop_phone,
            phoneEn: settings?.shop_phone_en || settings?.shop_phone,
            addressAr: settings?.shop_address,
            addressEn: settings?.shop_address_en || settings?.shop_address,
          },
